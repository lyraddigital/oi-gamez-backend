...
export const getOptionalDynamoString = (
  dynamoField?: AttributeValue
): string | undefined => {
...
export const getDynamoSet = (
  dynamoField?: AttributeValue,
  defaultValue: string[] = []
): string[] => {
  return dynamoField?.SS || defaultValue;
};
...
export const getDynamoList = (
  ...
  return dynamoField?.L || defaultValue;
};
...
export const getOptionalDynamoBoolean = (
  dynamoField?: AttributeValue
): boolean | undefined => {
  return dynamoField?.BOOL;
};

export const getDynamoMap = (
  dynamoField: AttributeValue,
  defaultValue: Record<string, AttributeValue> = {}
): Record<string, AttributeValue> => {
  return dynamoField?.M || defaultValue;
};
...
export const dynamoFieldValues: DynamoFieldValues = {
  ...
  gameSession: {
    ...
    currentQuestionNumber: (questionNumber) => numberAttribute(questionNumber),
